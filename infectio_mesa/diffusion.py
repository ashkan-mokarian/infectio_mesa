    ...
    def __init__(self, gamma: float,
        ...
        Args:
            gamma: modified constant for the heat equation.
              ...
              diffusion constant and delta s are discretization resolutions in
              space and time
            width:
            height:
        ...
        self.gamma = gamma
        # convolution kernel for central difference in space
...
if __name__ == '__main__':
    ...
    #     diff.step()
    #     # plt.pause(0.1)
    #     print(t, diff.u.shape, diff.u.max(), diff.u.sum())
